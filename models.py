...
db = SQLAlchemy()  # Creates SQLAlchemy's instance
bcrypt = Bcrypt()  # Creates Bcrypt's instance
...
class User(db.Model):
    """Allows for a user instance to be created."""
...
class Asset(db.Model):
    """Allows for an asset instance to be created."""
...
class UserAssetComparison(db.Model):
    """Allows for a user asset comparison instance to be created."""
